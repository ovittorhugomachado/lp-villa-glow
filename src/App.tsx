...
function App() {
  return (
    <>
      ...
      <div
        id="first-fold"
        className="min-h-32 bg-[#C3973B] flex flex-col justify-center items-center"
      >
        <h4
          id="text-hero"
          className="sm:text-2xl text-[#030332] font-bold text-center px-3 py-4 z-50 relative"
        >
          Um ateliê de pintura neon no escuro para toda a família se divertir e
          criar lembranças!
        </h4>
      </div>
      <section className="overflow-hidden w-screen min-h-screen flex flex-col relative bg-[#000000]">
        ...
        />
        <div
          className={`hidden lg:flex 2xl:hidden absolute bottom-0 right-0 p-3 w-18 h-18 bg-black items-center justify-center z-20`}
        >
          <img
            src="/images/favicon-g.png"
            alt="Logo Allos"
      ...
      <section
        id="second-fold"
        className="w-screen overflow-hidden h-300 bg-[#C3973B] md:h-270 py-12 md:py-0 relative flex flex-col lg:flex-row justify-center lg:justify-start items-center"
      >
        <VideoComponent
        ...
        <div className="w-full h-full flex flex-col gap-3 max-w-136 px-4 lg:pt-36 lg:ml-18 pt-10 text-center md:text-start md:px-8 z-50">
          ...
          <h4 className="text-[18px] md:text-[19px] font-bold">
            Valor único promocional
          </h4>
          {/* <h4 className="text-[18px] md:text-[19px] font-bold">- Segunda a quinta-feira R$ 49,90</h4> */}
          <h4 className="text-[18px] md:text-[19px] font-bold">
            - Segunda a domingo R$ 65,00
          </h4>
          <h4 className="text-[16px] md:text-[16px] font-bold">
            - Sujeita à lotação
          </h4>
          <h4 className="text-[16px] md:text-[16px] font-bold">
      ...
      <section
        id="hero-fold-2"
        className="w-screen bg-black/50 shadow-2xl min-h-screen relative flex items-center justify-center"
      >
        <VideoComponent
        ...
        />
        <div
          className={`hidden lg:flex xl:hidden absolute bottom-0 right-0 p-2 w-15 h-15 bg-black items-center justify-center z-20`}
        >
          <img
            src="/images/favicon-g.png"
            alt="Logo Allos"
        ...
        <div className="flex flex-col items-center px-8 lg:scale-130 z-10">
          <img
            src="/images/logo-villa-lobos.png"
            alt="logo-villa-lobos"
            className="w-30"
          />
          <h1 className="text-7xl whitespace-nowrap text-[#C3973B]">
            Villa Glow
          </h1>
          <h4 className="text-white text-2xl">Pintando no escuro</h4>
          <img src="/images/sublinhado.png" alt="sublinhado" className="w-25" />
      ...
      <section
        id="third-fold"
        className="w-screen relative flex flex-col md:flex-row justify-center lg:justify-end px-8 py-24 items-center bg-[#030332]"
      >
        <div className="md:mr-6 text-white z-50">
          <h4 className="text-[28px] font-extrabold text-center md:text-end">
            Localização
          </h4>
          <h5 className="text-[21px] font-bold text-center md:text-end">
      ...
      <footer className="bg-[#030332] border-t-2 border-[#C3973B] h-36 flex justify-center items-center gap-4">
        ...
        <a target="_blank" href="https://allos.co/">
          <img
            src="/images/logo-allos.png"
            alt="Logo Allos"
            className="w-25 h-auto object-contain border-l-2 border-white pl-3"
          />
        </a>
      </footer>
    </>
