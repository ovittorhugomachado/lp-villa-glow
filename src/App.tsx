        ...
        <>
            ...
            <section id="hero-fold" className="w-screen min-h-screen flex items-center justify-center sm:justify-start">
                <div className="flex flex-col items-center px-8 lg:pl-36 lg:scale-130">
                    ...
                    <a className="px-8 pt-1 pb-1.5 rounded-full text-lg font-semibold text-[#030332] bg-[#04CFBE] text-center mt-4">Quero participar <br className="md:hidden" /> do Villa Glow</a>
                </div>
            </section>
            ...
            <section id="third-fold" className="w-screen relative flex flex-col md:flex-row justify-center lg:justify-end px-8 py-24 items-center bg-[#030332]">
                ...
                <div className="md:mr-6 text-white z-50">
                    ...
                    <a
                        ...
                        target="_blank"
                        className="bg-[#04CFBE] flex justify-center mt-6 mb-4 text-[#030332] font-bold py-2 px-4 rounded-full transition-colors duration-200"
                    >
                        Como chegar
                    </a>
                </div>
            ...
            <footer className="bg-[#030332] border-t-2 border-[#04CFBE] h-36 flex justify-center items-center gap-4">
